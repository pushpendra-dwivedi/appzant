...
<body>
  ...
  <!-- Inner Page Hero -->
  <section class="section-padding position-relative" style="margin-top: 76px; background: url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop') no-repeat center center / cover; border-bottom: 1px solid rgba(0,0,0,0.05);">
    <div class="position-absolute top-0 start-0 w-100 h-100" style="background: rgba(255,255,255,0.9);"></div>
    <div class="container text-center position-relative" style="z-index: 2;" data-aos="fade-up">
      ...
      <p class="lead text-dark opacity-75 max-w-600 mx-auto">Enterprise-grade solutions tailored for your organizational needs.</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row align-items-center mb-5">
        <div class="col-lg-6" data-aos="fade-right">
          ...
          <p class="text-dark opacity-75 mb-4">Appzant provides industry-leading strategies to optimize performance, enhance security, and accelerate cloud migration.</p>
        ...
        <div class="col-lg-6" data-aos="fade-left">
          <div class="position-relative p-3">
             <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop" alt="Technology Visualization" class="img-fluid rounded-4 shadow-lg border border-light" style="opacity: 0.9;">
